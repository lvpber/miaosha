...
public class CodeMsg
{
    ...
    public static CodeMsg PASSWORD_EMPTY = new CodeMsg(500211,"登陆密码为空");
    public static CodeMsg MOBILE_EMPTY = new CodeMsg(500212,"登陆账户手机号为空");
    public static CodeMsg MOBILE_ERROR = new CodeMsg(500213,"登陆手机号格式错误");
